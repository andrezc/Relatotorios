...
uses
  ...
  Dialogs, Grids, Wwdbigrd, Wwdbgrid, StdCtrls, ExtCtrls, DB, UDiverso,
  IBCustomDataSet, IBQuery, DUtilit, DBGrids, IBUpdateSQL, Buttons,
  IBSQL, IBODataset, UComum, JvExControls, JvComponent, JvXPCore, JvXPButtons,
  JvComponentBase, JvgCheckBox, JvXPCheckCtrls, IB_Components, JvLabel,
  MMJPanel;
